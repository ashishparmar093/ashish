...
<html>
    ...
    <center>
        <form method='POST' action=''>
            ...
            <table border='10' bgcolor='Bisque'>
                <tr>
                <tr><td width='250'><b><select name="sel">
                                <option><b>Select Category</b></option> color='Bisque'
                                ...
                                if (isset($_REQUEST['sbmt'])) {
                                    ...
                                    if ($sel == "Day") {
                                        ...
                                        while ($rows = mysql_fetch_array($q2)) {
                                            ...
                                            echo "<tr bgcolor='Bisque'><td>$day</td>" . "<td>$sem</td>" . "<td>$Period_1</td>" . "<td>$Period_2</td>" . "<td>$Period_3</td>" . "<td>$Period_4</td>" . "<td>$rec</td>" . "<td>$Period_5</td>" . "<td>$Period_6</td>" . "<td>$Period_7</td>" . "<td>$Period_8</td></tr>";
                                        }
                                        if ($error == 1)
                                    ...
                                    /* SEMESTER */
                                    if ($sel == "Sem") {
                                        $q3 = mysql_query("select * from routine where Sem='$sem'") or die(mysql_error());
                                        ...
                                        $q4 = mysql_query("select * from routine where Sem='$sem'") or die(mysql_error());
