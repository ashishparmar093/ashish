...
<table border='10' bgcolor='pink'><h1 ><font color='blue'><b>ROUTINE INFORMATION SYSTEM</b></font></h1>
...
<tr><td width='250'><b>Select Any One:<select name="sel">
  ...
  <td><input type="text" name="inp" placeholder="ENTER INPUT"><input type="submit" name="sbmt">&nbsp&nbsp&nbsp&nbsp<a href='tprofile.php'>BACK</a>
...
if(isset($_REQUEST['sbmt']))
 {
  ...
  if($sel=="Day")
  {
    ...
    while($rows=mysql_fetch_array($q2))
    {
        ...
        echo "<tr bgcolor='pink'><td>$day</td>"."<td>$sem</td>"."<td>$Period_1</td>"."<td>$Period_2</td>"."<td>$Period_3</td>"."<td>$Period_4</td>"."<td>$rec</td>"."<td>$Period_5</td>"."<td>$Period_6</td>"."<td>$Period_7</td>"."<td>$Period_8</td></tr>";
